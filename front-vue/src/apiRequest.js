export default function apiResponse(method, endpoint, key, parameters, callback, thisArg) {
          ...
          case 4:
              ...
              if (request.status == 200) {
                  ...
                  if (key === '') {
                      ...
                      callback.call(thisArg, response_data);
                  } else {
                      console.log("Complete!! Received in JSON format.\n");
                      console.log(response_data[key]);
                      // コールバック
                      callback.call(thisArg, response_data[key]);
                  }
              } else {
